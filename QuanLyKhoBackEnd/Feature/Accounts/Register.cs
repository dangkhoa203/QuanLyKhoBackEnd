...
namespace QuanLyKhoBackEnd.Feature.Accounts {
    public class Register : IEndpoint {
        ...
        private static async Task<IResult> Handler(Request request, ApplicationDbContext context, UserManager<Account> userManager, SignInManager<Account> signInManager, ClaimsPrincipal User, EmailSender emailSender) {
            try {
